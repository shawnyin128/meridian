...
- concepts_missing_minimal_checks: 0
- low_information_concept_stubs: 0
- duplicate_concept_alias_groups: 0
- source_quality_contamination: 0

## Interpretation

Concept pages are preliminary knowledge pages for implementation and research-design background. Warnings usually mean a method/topic has not yet linked prerequisites; errors indicate source-quality boundary risk.

## Sample: unpromoted_candidate_concepts
...
## Sample: topic_missing_key_concepts
