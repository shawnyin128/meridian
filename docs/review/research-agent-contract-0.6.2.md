...
- live Codex eval:
  `python -m meridian eval codex-research-agent-contract eval/cases/research_agent_contract_live.jsonl --out-dir eval/runs/research-agent-contract-live-20260616-final2 --overwrite --timeout 300`
  passed `16/16` cases.
