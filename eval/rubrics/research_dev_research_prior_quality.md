...
3: Retrieves context but does not connect it to the plan.
5: Uses Paper Wiki grounding to shape the approach, experiment, prompt, metric,
or failure interpretation with concise page references and impact notes.
...
5: Stores compact status, trigger, query, grounding, judgment, confirmation, and
impact that later Lab work can reuse.
