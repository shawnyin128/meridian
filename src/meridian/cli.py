...
def build_parser() -> argparse.ArgumentParser:
    ...
    codex_routing = eval_subparsers.add_parser(
        "codex-routing",
        help="Run live Codex exec prompts over Meridian routing cases.",
    )
    codex_routing.add_argument("cases", type=Path, help="JSONL skill behavior cases.")
    codex_routing.add_argument("--out-dir", type=Path, required=True, help="Directory for live Codex outputs.")
    codex_routing.add_argument("--repo-root", type=Path, default=Path.cwd(), help="Target repo for codex exec -C.")
    codex_routing.add_argument("--codex-bin", default="codex", help="Codex executable. Defaults to codex.")
    codex_routing.add_argument(
        "--agent", choices=["codex", "claude"], default="codex", help="Which CLI agent runs the live cases."
    )
    codex_routing.add_argument("--claude-bin", default="claude", help="Claude Code executable. Defaults to claude.")
    codex_routing.add_argument("--model", default=None, help="Optional Codex model override.")
    codex_routing.add_argument("--profile", default=None, help="Optional Codex profile.")
    codex_routing.add_argument("--case-id", action="append", default=None, help="Run only this case id. Repeatable.")
    codex_routing.add_argument("--limit", type=int, default=None, help="Optional number of cases to run.")
    ...
    codex_lab_grounding.add_argument(
        "--claude-bin", default="claude", help="Claude Code executable. Defaults to claude."
    )
    ...
    codex_lab_graph.add_argument("--claude-bin", default="claude", help="Claude Code executable. Defaults to claude.")
    ...
    codex_contract.add_argument("--agent", choices=["codex", "claude"], default="codex")
    codex_contract.add_argument("--claude-bin", default="claude")
    ...
    codex_repo_startup.add_argument("--agent", choices=["codex", "claude"], default="codex")
    codex_repo_startup.add_argument("--claude-bin", default="claude")
