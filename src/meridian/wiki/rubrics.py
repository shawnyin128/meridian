...
UNDERSTANDING_RUBRIC = AgentRubric(
    ...
    dimensions=[
        ...
        RubricDimension(
            ...
            1.1,
            "Reader A understands why the page should be retrieved from frontmatter and does not confuse method families, research topics, settings, aliases, or exact component records.",
            _anchors("retrieval schema understanding"),
            ["paper.md frontmatter", "Retrieval Notes", "candidate method records", "Reader A retrieval explanation"],
...
QUALITY_RUBRIC = AgentRubric(
    ...
    dimensions=[
        ...
        RubricDimension(
            ...
            1.1,
            "Frontmatter is the machine-readable retrieval source of truth, while body retrieval notes explain use-cases rather than copying methods/topics/settings/datasets/metrics lists.",
            _anchors("frontmatter/body non-duplication"),
            ["paper.md frontmatter", "Retrieval Notes section"],
            ["Body has a `Retrieval Anchors` list that repeats frontmatter.", "`Retrieval Notes` restates every frontmatter field instead of explaining retrieval scenarios."],
        ),
        RubricDimension(
            "retrieval_coverage",
            1.4,
...
STRUCTURAL_RUBRIC = AgentRubric(
    ...
    dimensions=[
        ...
        RubricDimension("frontmatter_body_source_of_truth", 1.1, "Frontmatter remains the machine-readable retrieval source of truth and body retrieval notes do not duplicate its field lists.", _anchors("frontmatter/body source of truth"), ["paper.md frontmatter", "Retrieval Notes section"], ["Retrieval Anchors repeats methods/topics/settings.", "Body does not say frontmatter is source of truth."]),
    ...
    hard_fail_rules=[
        ...
        HardFailRule("duplicated_retrieval_sections", "paper.md uses body retrieval lists as a second metadata source instead of source-of-truth frontmatter plus retrieval notes.", "paper.md headings and section content", "paper_page_template"),
