...
def run_codex_lab_graph_eval(
    *,
    ...
    for case in selected_cases:
        ...
        claude_error = _write_claude_last_message(completed.stdout or "", last_message_path) if agent == "claude" else None
