    ...
    for package_root in [
        ...
        if package_skills != PRODUCT_SKILLS:
            _add(
                ...
                "Keep plugin packages limited to the declared Meridian product skills.",
            )
...
def _runtime_category() -> FrameworkCategory:
    ...
    if missing or extra:
        _add(
            ...
            "Keep MCP tools small and scenario-facing across Wiki, Project Workspace, and Lab workflows.",
        )
    return _category(category, findings)
