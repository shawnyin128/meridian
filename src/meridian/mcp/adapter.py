...
from meridian.mcp.app_library import (
    app_native_candidates,
    app_native_catalog_records,
    is_app_native_wiki,
)
...
def capabilities(*, detail: str = "summary") -> dict[str, Any]:
    ...
    response: dict[str, Any] = {
        ...
        "entry_model": {
            ...
            "source_of_truth": (
                "The configured Markdown Paper Wiki and each repository's declared .meridian surfaces; "
                "MCP is only a delivery layer."
            ),
        },
...
def context(
    *,
    ...
    if is_app_native_wiki(wiki_root):
