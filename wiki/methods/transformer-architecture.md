...
revision_id: "knowledge-cbc84997be"
---
# transformer architecture

## What It Is

This is a compiled method-family page for `transformer architecture`. It groups canonical paper pages that use or discuss the method; source-grounded claims remain on the linked paper/evidence pages.
...
- [[papers/Bodnar-et-al-2025-A-foundation-model-for-the-Earth-system|Bodnar et al. - 2025 - A foundation model for the Earth system]]: ### Bodnar et al. - 2025 - A foundation model for the Earth system - Purpose: Our approach uses low-rank adaptation (LoRA)53 to fine-tune all linear layers in the backbone’s self-attention opera- tions, allowing adaptation of very large mod...
...
- [[papers/Vaswani-et-al-2023-Attention-Is-All-You-Need|Vaswani et al. - 2023 - Attention Is All You Need]]: ### Vaswani et al. - 2023 - Attention Is All You Need - Purpose: We propose a new simple network architecture, the Transformer, based solely on attention mechanisms, dispensing with recurrence and convolutions entirely. In this work we prop...
...
- [[papers/Bodnar-et-al-2025-A-foundation-model-for-the-Earth-system|Bodnar et al. - 2025 - A foundation model for the Earth system]]: - Bodnar et al. - 2025 - A foundation model for the Earth system: Track rollout length, reward normalization, KL/clip constraints, seed variance, and baseline policy performance. - Vision-language: Evaluate text-only, im...
...
- [[papers/Vaswani-et-al-2023-Attention-Is-All-You-Need|Vaswani et al. - 2023 - Attention Is All You Need]]: - Vaswani et al. - 2023 - Attention Is All You Need: Unit test attention mask, positional bias shape, Q/K/V projection shapes, and sequence-length extrapolation cases. - Equation-bearing sections exist; turn each extract...
...
- [[papers/Bodnar-et-al-2025-A-foundation-model-for-the-Earth-system|Bodnar et al. - 2025 - A foundation model for the Earth system]]: - Some hardware evidence depends on simulation or specific CPU/kernel settings. Open questions: - Do key figures, tables, or equations change the interpretation of the text extraction?
...
- [[papers/Vaswani-et-al-2023-Attention-Is-All-You-Need|Vaswani et al. - 2023 - Attention Is All You Need]]: - Attention architecture claims can depend on sequence length, mask convention, positional encoding, and training compute. - Quality improvements should be checked against ablations that isolate architecture from data sc...
...
- [[papers/Bodnar-et-al-2025-A-foundation-model-for-the-Earth-system|Bodnar et al. - 2025 - A foundation model for the Earth system]]: Evidence takeaways: - Evidence should be read through reported tables/figures/ablations, runtime or memory measurements, quality metrics; keep mechanism support, quality metrics, and systems/runtime claims separate. Clai...
...
- [[papers/Vaswani-et-al-2023-Attention-Is-All-You-Need|Vaswani et al. - 2023 - Attention Is All You Need]]: Evidence takeaways: - Evidence should be read through reported tables/figures/ablations, runtime or memory measurements, quality metrics; keep mechanism support, quality metrics, and systems/runtime claims separate. Clai...
