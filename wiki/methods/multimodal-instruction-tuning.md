...
revision_id: "knowledge-8b4ff116f2"
---
# multimodal instruction tuning

## What It Is

This is a compiled method-family page for `multimodal instruction tuning`. It groups canonical paper pages that use or discuss the method; source-grounded claims remain on the linked paper/evidence pages.
