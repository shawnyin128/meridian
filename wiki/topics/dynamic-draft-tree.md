...
revision_id: "knowledge-c42db779b5"
---
# dynamic draft tree

## Scope

This topic page compiles canonical paper pages around `dynamic draft tree`. It is a navigation and synthesis surface; paper-specific source facts remain in the linked pages.
...
- [[papers/Sadhukhan-et-al-2025-MagicDec-Breaking-the-Latency-Throughput-Tradeoff-for-Long-Context-Generation-with-Speculative-Deco|Sadhukhan et al. - 2025 - MagicDec Breaking the Latency-Throughput Tradeoff for Long Context Generation with Speculative Deco]]: Sadhukhan et al. - 2025 - MagicDec Breaking the Latency-Throughput Tradeoff for Long Context Generation with Speculative Deco: Compresses the decode-time KV cache by selecting which cached key/value entries to retain und...
