...
revision_id: "knowledge-bb131b6ea1"
---
# LLM agents

## Scope

This topic page compiles canonical paper pages around `LLM agents`. It is a navigation and synthesis surface; paper-specific source facts remain in the linked pages.
