...
revision_id: "knowledge-d1b9005e7b"
---
# activation outliers

## Scope

This topic page compiles canonical paper pages around `activation outliers`. It is a navigation and synthesis surface; paper-specific source facts remain in the linked pages.
...
- Retrieve this topic when comparing papers, mechanisms, limitations, or implementation hooks around `activation outliers`.
